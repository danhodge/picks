...
function Shell(props: AppProps) {
  ...
  return doneLoading ?
    <div className="flex flex-col bg-yellow-100 container min-w-full h-full">
      <header className="bg-yellow-200 container flex flex-row items-center sticky top-0 left-0 min-w-full h-14 px-4">
        ...
        {view === "scoreboard" ?
          <div></div> :
          <div className="flex-none text-left basis-1/4 text-base font-semibold pl-6">
      ...
      <div className="bg-yellow-100 p-20 flex flex-grow" />
    </div > :
    loading();
}
